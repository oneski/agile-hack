...
class MessagesViewController: JSQMessagesViewController {
    ...
    func setupFirebase() {
        ...
        messagesRef = Firebase(url: "https://popping-inferno-574.firebaseio.com/classes/CALCB/messages")

        // *** STEP 4: RECEIVE MESSAGES FROM FIREBASE (limited to latest 50 messages)
        messagesRef.queryLimitedToNumberOfChildren(50).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) in

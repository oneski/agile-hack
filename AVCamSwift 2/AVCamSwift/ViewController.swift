...
class ViewController: UIViewController, AVCaptureFileOutputRecordingDelegate,  UIPickerViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    @IBOutlet weak var testLabel: UITextField!
    @IBOutlet weak var outputLabel: UILabel!
    @IBAction func dismissText(sender: AnyObject) {
        self.resignFirstResponder()
        outputLabel.text = "THIS WORKS"
...
//    Draw initialize global outlets
